...
- [Web Client Guide](https://github.com/Lightstreamer/Lightstreamer-lib-client-javascript/blob/v8.0.7-Web/docs/WebClientGuide.adoc)
- [API Reference](https://lightstreamer.com/api/ls-web-client/8.0.7)
...
You can build a custom library comprising only the modules you need. Refer to the [Github project](https://github.com/Lightstreamer/Lightstreamer-lib-client-javascript) for further information.